...
class Triangle:
    ...
    def make4(self):
        center = self.center()
        t1 = Triangle(center.x, center.y, self.apex0.x, self.apex0.y, self.apex2.x, self.apex2.y)
        t2 = Triangle(self.apex0.x, self.apex0.y, self.apex1.x, self.apex1.y, center.x, center.y)
        t3 = Triangle(self.apex1.x, self.apex1.y, center.x, center.y, self.apex2.x, self.apex2.y)
        t4 = Triangle(self.apex0.x, self.apex0.y, center.x, center.y, (self.apex0.x + self.apex1.x) / 2,
                      (self.apex0.y + self.apex1.y) / 2)
        return [t1, t2, t3, t4]
